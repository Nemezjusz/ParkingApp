...
//   void _startPolling() {
//     _pollingTimer = Timer.periodic(const Duration(seconds: 60*5), (timer) {
...
//     try {
//       final newParkingState = await ApiService.getParkingStatus();
//       final newUserReservations = await ApiService.fetchUserReservations();
